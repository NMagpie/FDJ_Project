...
with(tile)
{
    ...
    if (position_meeting(x,              y - img_height, oWall))  u = 1;
    if (position_meeting(x + img_width,  y,              oWall))  r = 2;
    if (position_meeting(x,              y + img_height, oWall))  d = 4;
    if (position_meeting(x - img_width,  y,              oWall))  l = 8;
    
    // Check corner existence
    if (position_meeting(x - img_height, y - img_width,  oWall))  ul = 1;
    if (position_meeting(x + img_height, y - img_width,  oWall))  ur = 2;
    if (position_meeting(x + img_height, y + img_width,  oWall))  dr = 4;
    if (position_meeting(x - img_height, y + img_width,  oWall))  dl = 8;
